...
str allcompsfilename 	= "../../common/gp1allcompnames.asc"
int ncomps 			= 585	// total # compartments in model. 
					// Keep this up to date!

str dendfilename 	= "../../common/gp1dendritenames.asc"
int num_dendcomps 		= 511	// total # dendritic compartments

str outputcompsfname 	= "../../common/gp1outputnames.asc"
int num_outputcomps 		= 25	// # compts listed in output_compnames

str STNfilename 	= "../../common/gp1_stn/gp1stn_1.asc"
int num_STN			= 100	// # STN inputs
str STN_scale		= "../../common/gp1_stn/gp1scale_1.asc"
...
str striatumfname 	= "../../common/gp1dendritenames.asc"
